...
namespace UnityQuickSheet
{
    internal class ScriptGenerator
    {
        ...
        private string ExcelClassNames
        {
            get
            {
                if (!string.IsNullOrEmpty(m_ScriptPrescription.excelClassNames))
                    return m_ScriptPrescription.excelClassNames;
                return "Error_Empty_ExcelClassNames";
            }
        }
        private string ExcelNames
        {
            get
            {
                if (!string.IsNullOrEmpty(m_ScriptPrescription.excelNames))
                    return m_ScriptPrescription.excelNames;
                return "Error_Empty_ExcelClassNames";
            }
        }
        ...
        public override string ToString ()
        {
            ...
            m_Text = m_Text.Replace("$Values", ExcelClassNames);
            m_Text = m_Text.Replace("$ExcelDataValues", ExcelNames);

...
namespace SUIFW
{
	public class BaseUIForm : MonoBehaviour {
        ...
        protected Dictionary<string, GameObject> children = new Dictionary<string, GameObject>();
        /* 属性*/
        //当前UI窗体类型
        ...
        protected GameObject GetChildObj(string name)
        {
	    ...
	    protected void RigisterButtonObjectEvent(string buttonName, EventTriggerListener.VoidDelegate  delHandle)
	    {
            ...
            GameObject goButton = GetChildObj(buttonName);
            //给按钮注册事件方法
            if (goButton != null)
            {
        ...
        protected void RigisterButtonByObject(GameObject go, EventTriggerListener.VoidDelegate delHandle)
        {
            if (go != null)
            {
	    ...
	    public string Show(string id)
        {
            ...
            strResult = LauguageMgr.Instance.ShowText(id);
            return strResult;
        }
